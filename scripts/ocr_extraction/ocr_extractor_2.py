#!/usr/bin/env python3
"""
ocr_extractor_2.py - Extracteur OCR PDF vers Markdown avec gestion des segments LogCard
...
class Phase1OCRExtractor:
    ...
    def _save_segment_result(self, segment_index, ocr_response, segment_info):
        ...
        segment_file = os.path.join(self.temp_dir, f"segment_{segment_index:03d}.md")
        ...
        segment_header = f"""<!-- SEGMENT {segment_index + 1} INFO
...
"""
        ...
        final_content = segment_header + segment_content
        ...
        print(f"💾 Segment {segment_index+1} sauvegardé ({len(final_content)} caractères)")
    
    def _consolidate_markdown_results(self):
        """Consolide tous les segments en un fichier Markdown final"""
