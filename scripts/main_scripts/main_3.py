#!/usr/bin/env python3
"""
main_3.py - Orchestrateur du workflow complet
...
from ocr_extractor_2 import Phase1OCRExtractor
from logcard_analyzer_3 import Phase2LogCardAnalyzer
...
def demonstrate_usage():
    ...
    print("   python main_3.py --full --pdf document.pdf")
    print()
    
    print("2️⃣  WORKFLOW AVEC CONFIGURATION DE STRUCTURE:")
    print("   python main_3.py --full --pdf document.pdf --structure-config structure.json")
    print()
    
    print("3️⃣  PHASE 1 SEULEMENT (PDF → Markdown):")
    print("   python main_3.py --phase1-only --pdf document.pdf")
    print("   python main_3.py --phase1-only --pdf document.pdf --structure-config structure.json")
    print()
    
    print("4️⃣  PHASE 2 SEULEMENT (Markdown → LogCards):")
    print("   python main_3.py --phase2-only --markdown document_ocr.md")
    print()
    
    print("5️⃣  AVEC OPTIONS:")
    print("   python main_3.py --full --pdf doc.pdf --structure-config config.json --keep-temp")
    print("   python main_3.py --full --pdf doc.pdf --output-dir /mon/dossier")
    print()
