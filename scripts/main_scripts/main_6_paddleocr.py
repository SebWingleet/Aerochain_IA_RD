#!/usr/bin/env python3
"""
main_6_paddleocr.py - Orchestrateur du workflow complet
...
from  ocr_extractor_5_lilian import Phase1OCRExtractor
from logcard_analyzer_6_lilian import Phase2LogCardAnalyzer
...
# ex : python3 main_6_paddleocr.py --full --pdf "/Users/sebastienbatty/Documents/1_Wingleet/2_DEV/THC/INPUT_DOCS/LOG CARDS - INVENTORY LOG BOOK 6 pages.pdf" --structure-config "/Users/sebastienbatty/Documents/1_Wingleet/2_DEV/THC/scripts/config_extraction_complete_file.json"

# ex : python main_6_paddleocr.py --full --pdf "C:\Users\lilia\Desktop\freelance\clients\Wingleet\Projet_DEV_Lilian\INPUT_DOCS\LOG CARDS - INVENTORY LOG BOOK Data Set.pdf" --structure-config "C:\Users\lilia\Desktop\freelance\clients\Wingleet\Projet_DEV_Lilian\scripts\config_extraction_complete_file.json"

# python main_6_paddleocr.py --phase2-only  --json "WORKFLOW_RESULTS\workflow_LOGCARDS-INVENTORYLOGBOOKDataSet_20250821_162354\phase1_ocr\LOGCARDS-INVENTORYLOGBOOKDataSet_ocr_result.json" 