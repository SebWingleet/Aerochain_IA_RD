...
from ocr_extractor import Phase1OCRExtractor
from logcard_analyzer_2 import Phase2LogCardAnalyzer

# from ..ocr_extraction.ocr_extractor import Phase1OCRExtractor
# from ..logcard_analyzer.logcard_analyzer_2 import Phase2LogCardAnalyzer
...
## python3 main_2.py --full --pdf "/Users/sebastienbatty/Documents/1_Wingleet/2_DEV/THC/INPUT_DOCS/LOG CARDS - INVENTORY LOG BOOK Data Set.pdf" --api-key "siKCdUiCHdqVO0v7paXDqgcEhB6aefky" --output-dir "/Users/sebastienbatty/Documents/1_Wingleet/2_DEV/THC/TEST/" --keep-temp